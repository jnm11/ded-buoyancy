...
xmin=-inf;
a=ded_gc_f7_g_classify(fns,-25,false);
save([dd '/dns-le-3d-2.mat'],'a');
a=ded_gc_f7_g_RJ(fns,xmin,false,'front'); 
save([dd '/dns-le-3d-1-f.mat'],'a');
a=ded_gc_f7_g_RJ(fns,xmin,false,'tail' ); 
save([dd '/dns-le-3d-1-t.mat'],'a');
