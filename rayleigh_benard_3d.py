...
#add_task is defined in evaluator.py
# Analysis
...
# CFL
CFL = flow_tools.CFL(solver, initial_dt=1e-4, cadence=5, safety=1.5,evaluator.py                     max_change=1.5, min_change=0.5, max_dt=0.05)
